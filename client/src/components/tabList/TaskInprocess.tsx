...
export class TaskInprocess extends React.PureComponent<TaskProps, TaskState> {
    ...
    render() {
        return (
            <>
                ...
                <div className="123456">
                <MDBModal show={this.state.basicModal} tabIndex='-1' staticBackdrop='true'>
                    <MDBModalDialog>
                        <MDBModalContent>
                            <MDBModalHeader>
                                <MDBModalTitle><div>
